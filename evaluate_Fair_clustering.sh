...
f_v_E=False # Set true to check the fairness error vs Discrete clustering energy plots in a lambda range. Note that, In this case also set --lmd_tune to True to have the default range.
conv=True # Set true to see if the algorithm converges.
lmd_tune=False
